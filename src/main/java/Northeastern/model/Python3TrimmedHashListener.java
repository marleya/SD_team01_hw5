...
public class Python3TrimmedHashListener implements Python3Listener {
   ...
   * AST
   */
  public Python3TrimmedHashListener() {
  ...
  private void enterNode(ParserRuleContext ctx) {
    ...
    if (!toBeIgnored) {
      Python3TrimmedHashVisitor visitor = new Python3TrimmedHashVisitor();
      int hashvalue = ctx.accept(visitor).hashCode();
