...
public interface JavaScriptParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#fromBlock}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFromBlock(JavaScriptParser.FromBlockContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#multipleImportStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMultipleImportStatement(JavaScriptParser.MultipleImportStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#exportStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#generatorFunctionDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitGeneratorFunctionDeclaration(JavaScriptParser.GeneratorFunctionDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#generatorBlock}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitGeneratorBlock(JavaScriptParser.GeneratorBlockContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#generatorDefinition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitGeneratorDefinition(JavaScriptParser.GeneratorDefinitionContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#iteratorBlock}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIteratorBlock(JavaScriptParser.IteratorBlockContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#iteratorDefinition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIteratorDefinition(JavaScriptParser.IteratorDefinitionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitGeneratorsExpression(JavaScriptParser.GeneratorsExpressionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitGeneratorsFunctionExpression(JavaScriptParser.GeneratorsFunctionExpressionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitIteratorsExpression(JavaScriptParser.IteratorsExpressionContext ctx);
	/**
